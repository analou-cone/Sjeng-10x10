...
/* #define NDEBUG - do this in the makefile if you're serious */
#include <assert.h>
...
#undef FASTCALC
#ifdef FASTCALC
#define rank(square) ((((square)-30)/plusRank)+1) //x
#define file(square) ((((square)-30)%plusRank)+1) //x
#else
