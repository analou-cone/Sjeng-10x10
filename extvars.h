...
extern int board[rankFileArraySize], moved[rankFileArraySize], ep_square, white_to_move, wking_loc,
  bking_loc, white_castled, black_castled, result, ply, pv_length[PV_BUFF],
  squares[rankFileArraySize], num_pieces, i_depth, comp_color, fifty, piece_count;
...
extern unsigned long history_h[rankFileArraySize][rankFileArraySize];
...
// unsure where the number comes from
extern int pieces[34];
extern int is_promoted[34];
...
extern unsigned long zobrist[17][rankFileArraySize];
...
extern const int rank[rankFileArraySize], file[rankFileArraySize], diagl[rankFileArraySize], diagr[rankFileArraySize], sqcolor[rankFileArraySize];
...
extern struct sdl_data *sdp;
extern int viewBoardPos;
extern int globalBoardPos;
extern int boardHistory[rankFileArraySize][1024];
